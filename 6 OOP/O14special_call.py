...
# 那么，怎么判断一个变量是对象还是函数呢？其实，更多的时候，我们需要判断一个对象是否能被调用，能被调用的对象就是一个Callable对象，比如函数和上面定义的带有__call__()的类实例：
# bool1 = callable(Student('zx'))
# bool2 = callable(max)
# bool3 = callable([1, 2, 3])
# bool4 = callable(None)
# bool5 = callable('str')
# print([bool1, bool2, bool3, bool4, bool5])


list1 = list (map(callable, [Student('zx'),max, [1, 2, 3], None, 'str']))
print(list1)
